<template>
  ...
  <section class="pt-32 px-6 pb-24 max-w-lg mx-auto">
    <h1 class="text-4xl font-extrabold mb-8 text-center">Créer un compte</h1>

    <!-- FORMULAIRE : l'événement "submit" est géré par la fonction registerUser -->
    ...
    <form @submit.prevent="registerUser"
      ...
      <div class="flex flex-col">
        ...
        <input v-model="username" type="text" placeholder="Ex: gamer123"
               class="p-3 rounded-lg bg-white/10 border border-white/20 focus:outline-none focus:ring-2 focus:ring-cyan-400 w-full">
      </div>
      ...
      <div class="flex flex-col">
        ...
        <input v-model="password" type="password" placeholder="Mot de passe"
               class="p-3 rounded-lg bg-white/10 border border-white/20 focus:outline-none focus:ring-2 focus:ring-cyan-400">
      </div>
      ...
      <!-- s'affiche uniquement si "message" contient une valeur -->
